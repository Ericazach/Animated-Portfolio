      ...
      <div className="w-full flex flex-col justify-center items-center gap-10">
        ...
        <div className="relative">
          ...
          <button
            type="button"
            onClick={handleCopy}
            className="mx-2 md:mx-20 text-neutral-200 bg-secondary-100 border border-gray-300 focus:outline-none hover:bg-gray-700 focus:ring-4 focus:ring-gray-100 font-bold rounded-lg text-md px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
          >
