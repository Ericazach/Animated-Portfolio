    ...
    >
      <div className="flex items-center justify-center gap-5">
        ...
        <motion.h1
          ...
          className="w-screen gap-2 md:gap-4 flex items-center justify-center font-extrabold font-ralewayLight uppercase mt-12  md:text-6xl text-3xl text-neutral-200"
        >
